...
RULES = [
    ...
    Rule([Match(title=r"^Extension:\s*\(Bitwarden Password Manager\)\s*-\s*—\s*Mozilla Firefox$", app_id=r"firefox")],
    ...
    Rule([Match(title=r"^Picture-in-Picture$", app_id="firefox")],
          width=600, height=360, centered=True),
    ...
    Rule([Match(title=r"^Extension:\s*\(Open in Browser\)\s*-\s*—\s*Zen Browser$", app_id="zen")],
          width=600, height=360, centered=True),
    Rule([Match(title=r"^Picture-in-Picture$", app_id="zen")],
          width=600, height=360, centered=True),
]
